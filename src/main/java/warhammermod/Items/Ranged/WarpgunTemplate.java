...
public class WarpgunTemplate  extends GunBase {
    ...
    public WarpgunTemplate(Item.Properties properties, String ammotype, int time, int magsize, float damagein){
