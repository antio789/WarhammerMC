...
public class GunSwordTemplate extends SwordItem implements Itimetoreload {
    ...
    public GunSwordTemplate(ItemTier tier, int time){
        super(tier,3 ,-2.4F,(new Properties()).group(reference.warhammer));
        timetoreload=time;

        ItemModelsProperties.func_239418_a_(this,new ResourceLocation("firing"),(p_210309_0_, p_210309_1_, p_210309_2_) -> {
