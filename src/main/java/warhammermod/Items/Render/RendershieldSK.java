...
import warhammermod.Items.Render.model.SkavenShieldModel;


public class RendershieldSK extends TileEntityItemStackRenderer {
    private static String resource_location="warhammermod:textures/items/skaven_shield.png";
    static final ResourceLocation SHIELD_TEXTURE = new ResourceLocation(resource_location);
    private final ModelShield model_Shield = new SkavenShieldModel();
