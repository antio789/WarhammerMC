...
public class repeaterhandgunmodel extends Model {
    ...
    public repeaterhandgunmodel() {
        ...
        this.barrel6.setRotationPoint(1.2F, -0.7F, -3F);
        ...
        this.barrel_holder1.setRotationPoint(0.5F, -2.0F, 8.0F);
        ...
        this.barrel2.setRotationPoint(-1.2F, -0.7F, -3F);
        ...
        this.barrel1.setRotationPoint(-0.5F, -1.9F, -3F);
        this.barrel1.addBox(0.0F, 0.0F, 0.0F, 1, 1, 9, 0.0F);
        this.barrel5 = new ModelRenderer(this, 0, 0);
        this.barrel5.setRotationPoint(1.2F, 0.7F, -3F);
