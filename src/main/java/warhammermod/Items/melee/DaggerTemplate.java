...
public class DaggerTemplate extends TieredItem implements IVanishable {
    ...
    public DaggerTemplate(IItemTier tier){
        super(tier, (new Properties()).tab(reference.warhammer));
        this.attackSpeed = 5;
    ...
    {
        return enchantment.category == EnchantmentType.WEAPON || super.canApplyAtEnchantingTable(stack,enchantment);
    }
