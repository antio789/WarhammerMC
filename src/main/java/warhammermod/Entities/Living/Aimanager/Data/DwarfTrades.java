...
public class DwarfTrades {
   public static final Map<DwarfProfession, Int2ObjectMap<ITrade[]>> TRADES = Util.make(Maps.newHashMap(), (p_221237_0_) -> {
      ...
      p_221237_0_.put(DwarfProfession.Slayer,func_221238_a(ImmutableMap.of(1,new ITrade[]{new EmeraldForItemsTrade(Items.COOKED_BEEF,12,15,5),new EmeraldForItemsTrade(Items.COOKED_CHICKEN,12,15,5),new EmeraldForItemsTrade(Items.COOKED_COD,12,15,5),new EmeraldForItemsTrade(Items.COOKED_MUTTON,12,15,5),new EmeraldForItemsTrade(Items.COOKED_PORKCHOP,12,15,5),new EmeraldForItemsTrade(Items.COOKED_RABBIT,12,15,5),new EmeraldForItemsTrade(Items.COOKED_SALMON,12,15,5)},2,new ITrade[]{new EmeraldForItemsTrade(Items.RABBIT_STEW,12,15,10),new EmeraldForItemsTrade(ItemsInit.Beer,3,30,15)},3,new ITrade[]{new ItemsForEmeraldsTrade(Items.BONE,20,1,30,10)},4,new ITrade[]{new EmeraldForItemsTrade(Items.STRING,18,1,20),new EmeraldForItemsTrade(Items.PHANTOM_MEMBRANE,40,3,30)},5,new ITrade[]{new ItemsForEmeraldsTrade(functions.getrandomskull(),60,1,1,40)})));
      ...
      p_221237_0_.put(DwarfProfession.Engineer, func_221238_a(ImmutableMap.of(1,new ITrade[]{new ItemsForEmeraldsTrade(ItemsInit.Cartridge,5,1,5),new ItemsForEmeraldsTrade(ItemsInit.Grenade,9,1,5),new ItemsForEmeraldsTrade(ItemsInit.Shell,6,1,5)},2,new ITrade[]{new EmeraldForItemsTrade(ItemsInit.Beer,2,30,8),new ItemsForEmeraldsTrade(functions.getRandomShield(),20,1,20),new ItemsForEmeraldsTrade(Items.PISTON,8,1,30,10),new ItemsForEmeraldsTrade(Items.DISPENSER,16,1,38,5)},3,new ITrade[]{new EnchantedItemForEmeraldsTrade(ItemsInit.thunderer_handgun,15,1,30),new ItemsForEmeraldsTrade(functions.getRandomShield(),15,1,1,15),new EnchantedItemForEmeraldsTrade(functions.getRandomarmor(0),15,5,20),new EnchantedItemForEmeraldsTrade(functions.getRandomarmor(1),15,5,20)},4,new ITrade[]{new EnchantedItemForEmeraldsTrade(ItemsInit.GrudgeRaker,16,1,20)},5,new ITrade[]{new EnchantedItemForEmeraldsTrade(ItemsInit.DrakeGun,20,1,30)})));
   });
      ...
      public MerchantOffer getOffer(Entity trader, Random rand) {
         if (!(trader.level instanceof ServerWorld)) {
            ...
            if (blockpos != null) {
               ...
               itemstack.setHoverName(new TranslationTextComponent("filled_map." + this.structureName.getFeatureName().toLowerCase(Locale.ROOT)));
   ...
   static class EnchantedItemForEmeraldsTrade implements ITrade {
      ...
      public MerchantOffer getOffer(Entity p_221182_1_, Random p_221182_2_) {
         ...
         ItemStack itemstack = EnchantmentHelper.enchantItem(p_221182_2_, new ItemStack(this.field_221195_a.getItem()), i, false);
   ...
   static class ItemWithPotionForEmeraldsAndItemsTrade implements ITrade {
      ...
      public MerchantOffer getOffer(Entity p_221182_1_, Random p_221182_2_) {
         ...
         ItemStack itemstack1 = PotionUtils.setPotion(new ItemStack(this.field_221219_a.getItem(), this.field_221220_b), potion);
