...
public class WarpbulletRender extends EntityRenderer<WarpBulletEntity> {
    ...
    public void render(WarpBulletEntity p_225623_1_, float entityYaw, float partialTicks, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int packedLightIn) {
        p_225623_4_.push();
    ...
    public ResourceLocation getEntityTexture(WarpBulletEntity entity) {
