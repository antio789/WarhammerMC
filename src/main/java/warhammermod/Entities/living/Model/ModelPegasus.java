...
public class ModelPegasus extends ModelBase
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        this.WingRbone.render(scale);
        this.WingLBone.render(scale);
    ...
    private float WingDirection=0.05F;
    private float WingAngleElytra=0.1F;
    private Byte ongroundtimer=0;
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        EntityPegasus pegasus = (EntityPegasus)entitylivingbaseIn;
        ...
        if(pegasus.isIsstationaryflying()) {
            if (Math.abs(WingAngle) > 0.6) {
                WingDirection*=-1;
            }
        ...
        }else if(pegasus.isIselytrafly()){
            if(pegasus.rotationPitch>0){WingAngleElytra=0.1F;}
