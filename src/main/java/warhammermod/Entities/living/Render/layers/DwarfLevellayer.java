...
public class DwarfLevellayer<T extends DwarfEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> implements ISelectiveResourceReloadListener {
    private static final Int2ObjectMap<ResourceLocation> pendantbylevel = Util.make(new Int2ObjectOpenHashMap<>(), (p_215348_0_) -> {
    ...
    public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        if (!p_225628_4_.isInvisible()) {
            ...
            if (prof != DwarfProfession.Warrior && !p_225628_4_.isChild()) {
                if (prof != DwarfProfession.Lord) {
                    ResourceLocation resourcelocation2 =  pendantbylevel.get(MathHelper.clamp(p_225628_4_.getLevel(), 1, pendantbylevel.size()));
                    renderCutoutModel(m, resourcelocation2, p_225628_1_, p_225628_2_, p_225628_3_, p_225628_4_, 1.0F, 1.0F, 1.0F);
                }
            }
        }
    }
