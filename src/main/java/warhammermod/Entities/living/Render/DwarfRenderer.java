...
public class DwarfRenderer extends MobRenderer<DwarfEntity, DwarfModel<DwarfEntity>> {
    ...
    public int getBlockLight(DwarfEntity entityIn, BlockPos partialTicks) {
        return entityIn.isBurning() || entityIn.getProfession().equals(DwarfProfession.Miner) ? 15 : entityIn.world.getLightFor(LightType.BLOCK, partialTicks);
    }

    protected void preRenderCallback(DwarfEntity p_225620_1_, MatrixStack p_225620_2_, float p_225620_3_) {
        float f = 0.9375F;
