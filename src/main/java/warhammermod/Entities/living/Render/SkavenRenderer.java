...
import warhammermod.Entities.living.Render.layers.SkavenHeldItemLayer;
import warhammermod.Entities.living.Render.model.SkavenModel;
...
public class SkavenRenderer extends MobRenderer<SkavenEntity, SkavenModel<SkavenEntity>> {
    ...
    protected void preRenderCallback(SkavenEntity skaven, MatrixStack p_225620_2_, float p_225620_3_) {
     ...
     */
    public ResourceLocation getEntityTexture(SkavenEntity entity)
    {
