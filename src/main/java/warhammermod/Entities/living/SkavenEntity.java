...
public class SkavenEntity extends MonsterEntity implements IRangedAttackMob {
    ...
    public void updateSkavenAttributes(double speed,double health,double armor,double AD){
        this.func_233645_dx_().func_233779_a_(Attributes.field_233818_a_).setBaseValue(health);
        this.func_233645_dx_().func_233779_a_(Attributes.field_233821_d_).setBaseValue(speed);
        this.func_233645_dx_().func_233779_a_(Attributes.field_233826_i_).setBaseValue(armor);
        this.func_233645_dx_().func_233779_a_(Attributes.field_233823_f_).setBaseValue(AD);
    }
    ...
    protected void registerTypesattributes(){
        ...
        this.updateSkavenAttributes(speed,max_health,armor,AD);
...
*/
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (livingentity != null && this.world.getDifficulty() == Difficulty.HARD && (double)this.rand.nextFloat() < reinforcementchance.get(getSkavenTypePosition())/2 && this.world.getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING)) {
                SkavenEntity zombieentity = Entityinit.SKAVEN.create(this.world);

                for(int l = 0; l < 50; ++l) {
                    int i1 = i + MathHelper.nextInt(this.rand, 7, 30) * MathHelper.nextInt(this.rand, -1, 1);
                    int j1 = j + MathHelper.nextInt(this.rand, 7, 30) * MathHelper.nextInt(this.rand, -1, 1);
                    int k1 = k + MathHelper.nextInt(this.rand, 7, 30) * MathHelper.nextInt(this.rand, -1, 1);
