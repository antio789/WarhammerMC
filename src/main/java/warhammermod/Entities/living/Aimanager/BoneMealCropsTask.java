...
public class BoneMealCropsTask extends Task<DwarfEntity> {
   ...
   private Optional<BlockPos> func_233997_b_(ServerWorld p_233997_1_, DwarfEntity p_233997_2_) {
   ...
   private void func_233994_a_(DwarfEntity p_233994_1_) {
