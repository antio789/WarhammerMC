...
public class ShowWaresTask extends Task<DwarfEntity> {
   @Nullable
   ...
   public boolean shouldExecute(ServerWorld worldIn, DwarfEntity owner) {
   ...
   public boolean shouldContinueExecuting(ServerWorld worldIn, DwarfEntity entityIn, long gameTimeIn) {
   ...
   public void startExecuting(ServerWorld worldIn, DwarfEntity entityIn, long gameTimeIn) {
   ...
   public void updateTask(ServerWorld worldIn, DwarfEntity owner, long gameTime) {
   ...
   public void resetTask(ServerWorld worldIn, DwarfEntity entityIn, long gameTimeIn) {
   ...
   private void func_220556_a(LivingEntity p_220556_1_, DwarfEntity p_220556_2_) {
      boolean flag = false;
   ...
   private void func_220558_a(DwarfEntity p_220558_1_) {
      p_220558_1_.setItemStackToSlot(EquipmentSlotType.MAINHAND, this.field_220560_b.get(0));
   }

   private void func_220555_b(DwarfEntity p_220555_1_) {
   ...
   private LivingEntity func_220557_c(DwarfEntity p_220557_1_) {
   ...
   private void func_220553_d(DwarfEntity p_220553_1_) {
