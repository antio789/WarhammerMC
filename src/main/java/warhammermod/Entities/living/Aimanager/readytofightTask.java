...
public class readytofightTask extends Task<DwarfEntity> {
   ...
   public readytofightTask(int p_i50361_1_, float p_i50361_2_, int p_i50361_3_) {
...
/*
   protected boolean shouldExecute(ServerWorld worldIn, DwarfEntity owner) {
      Optional<BlockPos> optional = worldIn.func_217443_B().func_219127_a((p_220454_0_) -> {
         return p_220454_0_ == PointOfInterestType.MEETING;
      }, (p_220456_0_) -> {
         return true;
   ...
   protected void startExecuting(ServerWorld worldIn, DwarfEntity entityIn, long gameTimeIn) {
      ...
      if (!optional.isPresent()) {
         optional = worldIn.func_217443_B().func_219163_a((p_220453_0_) -> {
            return p_220453_0_ == PointOfInterestType.MEETING;
         }, (p_220455_0_) -> {
            return true;
      ...
      if (optional.isPresent()) {
         ...
         brain.removeMemory(WarhammermodRegistry.BREED_TARGET);
