...
public class StayNearPointTask extends Task<DwarfEntity> {
   ...
   private void func_225457_a(DwarfEntity p_225457_1_, long p_225457_2_) {
      Brain<?> brain = p_225457_1_.getBrain();
      p_225457_1_.onDeathUpdatePOI(this.field_220548_a);
   ...
   private boolean func_223017_a(ServerWorld p_223017_1_, DwarfEntity p_223017_2_) {
   ...
   private boolean func_220546_a(ServerWorld p_220546_1_, DwarfEntity p_220546_2_, GlobalPos p_220546_3_) {
   ...
   private boolean func_220547_b(ServerWorld p_220547_1_, DwarfEntity p_220547_2_, GlobalPos p_220547_3_) {
