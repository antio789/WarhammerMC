...
public class RangedSkavenGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
   private final SkavenEntity entity;
   ...
   public RangedSkavenGoal(SkavenEntity mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
      this.entity = mob;
   ...
   protected boolean isBowInMainhand()
   {
      ...
      return (!item.isEmpty() && (item.getItem() instanceof WarpgunTemplate || item.getItem() instanceof RatlingGun || item.getItem() instanceof Slingtemplate))||entity.getSkaventype().equals(reference.globadier);
   }
