...
public class EntityAIAttackRangedmusket<T extends EntityMob & IRangedAttackMob> extends EntityAIBase
{
    ...
    public EntityAIAttackRangedmusket(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_)
    {
    ...
    {
        return !this.entity.getHeldItemMainhand().isEmpty() && (this.entity.getHeldItemMainhand().getItem() instanceof GunBase|| entity.getHeldItemMainhand().getItem() instanceof gunswtemplate);
    }
