...
public class RegistryHandler {
    ...
    public static class Events {
        ...
        public static void onItemregister(RegistryEvent.Register<Item> event) {
            ...
            ItemsInit.DWARF_SPAWN_EGG = new SpawnEggItem(Entityinit.DWARF,1599971,15721509,(new Item.Properties()).group(reference.warhammer)).setRegistryName("dwarf_egg");
            ItemsInit.Skaven_SPAWN_EGG = new SpawnEggItem(Entityinit.SKAVEN, 16711680,894731, (new Item.Properties()).group(reference.warhammer)).setRegistryName("skaven_egg");
