...
public class Entityinit {
    ...
    public static EntityType<PegasusEntity> PEGASUS = EntityType.Builder.create(PegasusEntity::new, EntityClassification.CREATURE).setTrackingRange(64).setUpdateInterval(1).setShouldReceiveVelocityUpdates(true).size(1.3964844F, 1.6F).build(location("pegasus").toString());
