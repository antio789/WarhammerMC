    ...
    public static void setStructuresGeneration(){
        for (Biome biome: BiomeList){
            ...
            if(biome.getRegistryName().toString().contains("mountains")){
                biome.func_235063_a_(WarhammermodRegistry.Dwarfvillage.get().func_236391_a_(new VillageConfig(new ResourceLocation(reference.modid,"dwarf_village/town_centers"), 6)));
                //biome.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, WarhammermodRegistry.Dwarf_village.func_236391_a_(VillageConfig));
                }
        }
    }
