...
public class ModJigsawManager extends JigsawManager {
    /**
     *
    ...
    public static void addPieces(DynamicRegistries p_242837_0_, VillageConfig p_242837_1_, JigsawManager.IPieceFactory p_242837_2_, ChunkGenerator p_242837_3_, TemplateManager p_242837_4_, BlockPos p_242837_5_, List<? super AbstractVillagePiece> p_242837_6_, Random p_242837_7_, boolean p_242837_8_, boolean p_242837_9_) {
        ...
        if (p_242837_1_.maxDepth() > 0) {
            ...
            jigsawmanager$assembler.placing.addLast(new Entry(abstractvillagepiece, new MutableObject<>(VoxelShapes.join(VoxelShapes.create(axisalignedbb), VoxelShapes.create(AxisAlignedBB.of(mutableboundingbox)), IBooleanFunction.ONLY_FIRST)), k + 80, 0));

            while(!jigsawmanager$assembler.placing.isEmpty()) {
                Entry jigsawmanager$entry = jigsawmanager$assembler.placing.removeFirst();
        ...
        private void tryPlacingChildren(AbstractVillagePiece p_236831_1_, MutableObject<VoxelShape> p_236831_2_, int p_236831_3_, int p_236831_4_, boolean p_236831_5_) {
            ...
            for(Template.BlockInfo template$blockinfo : jigsawpiece.getShuffledJigsawBlocks(this.structureManager, blockpos, rotation, this.random)) {
                ...
                if (optional.isPresent() && (optional.get().size() != 0 || Objects.equals(resourcelocation, JigsawPatternRegistry.EMPTY.location()))) {
                    ...
                    resourcelocation1 = new ResourceLocation( replacemcifnecessary(resourcelocation.toString()));
                    ...
                    if (optional1.isPresent() && (optional1.get().size() != 0 || Objects.equals(resourcelocation1, JigsawPatternRegistry.EMPTY.location()))) {
                                    ...
                                    if (JigsawBlock.canAttach(template$blockinfo, template$blockinfo1)) {
                                        ...
                                        if (!VoxelShapes.joinIsNotEmpty(mutableobject1.getValue(), VoxelShapes.create(AxisAlignedBB.of(mutableboundingbox3).deflate(0.25D)), IBooleanFunction.ONLY_SECOND)) {
                                            ...
                                            if (p_236831_4_ + 1 <= this.maxDepth) {
                                                this.placing.addLast(new Entry(abstractvillagepiece, mutableobject1, l, p_236831_4_ + 1));
                                            }
                                            continue label139;
                                        }
                                    }
                        ...
                        System.out.println("Empty or none existent fallback pool: {}"+ (Object)resourcelocation1);
                    }
                } else {
                    System.out.println("Empty or none existent pool: {}"+ (Object)resourcelocation);
                }
            }
